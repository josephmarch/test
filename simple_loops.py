...
# If two numbers are provided then a For loop will loop from the first number until it reaches the second number
for x in range(20,30):
    print(x)

# If a list is proveded, then the For loop will loop through each element within the list
